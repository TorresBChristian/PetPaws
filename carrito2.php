...
<body>
   ...
   <main class="mt-5" style=" font-family: 'Roboto';">
        ...
        <div class="container-product mt-5" id="lista-productos"> 
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mt-3 mb-4">
                            ...
                            <div class="card-header">
                                <h4 class="my-0 font-weight-bold" style="font-size: 20px">Juguete para perro</h4>
                            </div>
                ...
                <div class="card mb-4 shadow-sm">                  
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mt-3 mb-4">
                            <li></li>
                            <div class="card-header">
                                <h4 class="my-0 font-weight-bold" style="font-size: 20px">Shampoo Troper</h4>
                            </div>
                ...
                <div class="card mb-4 shadow-sm">                  
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mt-3 mb-4">
                            <li></li>
                            <div class="card-header">
                                <h4 class="my-0 font-weight-bold" style="font-size: 20px">Arenero para gatos</h4>
                            </div>
            ...
            <div class="card-deck mb-3 text-center">
                <div class="card mb-4 shadow-sm">                  
                    <div class="card-body">
                        <img src="./public/assets/product-4.png" class="card-img-top">
                        <ul class="list-unstyled mt-3 mb-4">
                            <li></li>
                            <div class="card-header">
                                <h4 class="my-0 font-weight-bold" style="font-size: 20px">Pedigree Adulto</h4>
                            </div>
                            <h1 class="card-title pricing-card-title precio">S/. <span class="">49.90</span></h1>
                        </ul>
                ...
                <div class="card mb-4 shadow-sm">                  
                    <div class="card-body">
                        <img src="./public/assets/product-5.png" class="card-img-top">
                        <ul class="list-unstyled mt-3 mb-4">
                            <li></li>
                            <div class="card-header">
                                <h4 class="my-0 font-weight-bold" style="font-size: 20px">Ricocat</h4>
                            </div>
                            <h1 class="card-title pricing-card-title precio">S/. <span class="">39.90</span></h1>
                        </ul>
                ...
                <div class="card mb-4 shadow-sm">                   
                    <div class="card-body">
                        <img src="./public/assets/product-6.png" class="card-img-top">
                        <ul class="list-unstyled mt-3 mb-4">
                            <li></li>
                            <div class="card-header">
                                <h4 class="my-0 font-weight-bold" style="font-size: 20px">Shampoo para perros</h4>
                            </div>
                            <h1 class="card-title pricing-card-title precio">S/. <span class="">15.99</span></h1>
                        </ul>
            ...
            <div class="card-deck mb-3 text-center">
                ...
                <div class="card mb-4 shadow-sm">                    
                    <div class="card-body">
                        <img src="./public/assets/product-7.png" class="card-img-top">
                        <ul class="list-unstyled mt-3 mb-4">
                            <li></li>
                            <div class="card-header">
                                <h4 class="my-0 font-weight-bold" style="font-size: 20px">Pedigree Saludable</h4>
                            </div>
                            <h1 class="card-title pricing-card-title precio">S/. <span class="">19.90</span></h1>
                        </ul>
                ...
                <div class="card mb-4 shadow-sm">              
                    <div class="card-body">
                        <img src="./public/assets/product-8.png" class="card-img-top">
                        <ul class="list-unstyled mt-3 mb-4">
                            <li></li>
                            <div class="card-header">
                                <h4 class="my-0 font-weight-bold" style="font-size: 20px">Pedigree en lata</h4>
                            </div>
                            <h1 class="card-title pricing-card-title precio">S/. <span class="">9.90</span></h1>
                        </ul>
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mt-3 mb-4">
                            <li></li>
                            <div class="card-header">
                                <h4 class="my-0 font-weight-bold" style="font-size: 20px">Jueguete para gatos</h4>
                            </div>
                            <h1 class="card-title pricing-card-title precio">S/. <span class="">15.99</span></h1>
                        </ul>
    ...
    <footer class="mt-5">
        <div class="content">
          ...
          <div class="middle box">
            ...
            <div class="center" ><a href="#">Misión y visión</a></div>
